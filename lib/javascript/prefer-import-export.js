...
new Synvert.Rewriter("javascript", "preferImportExport", () => {
  description(`
  ...
  withFiles("**/*.js", function () {
    ...
    withNode({ type: "ExpressionStatement", expression: { type: 'AssignmentExpression', left: { type: 'MemberExpression', object: 'module', property: 'exports' }, right: { type: 'ObjectExpression' } } }, () => {
