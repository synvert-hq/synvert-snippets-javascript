...
new Synvert.Rewriter("javascript", "no-unused-require", () => {
  ...
  withinFiles("**/*.js", function () {
    ...
    const used = {};
    withNode(
      { type: "VariableDeclarator", id: { type: "Identifier" }, init: { type: "CallExpression", callee: "require" } },
      () => {
    ...
    withNode(
      {
        ...
        init: { type: "CallExpression", callee: "require" },
      },
      () => {
      ...
      ifAllNodes(
        ...
        () => {
          withNode(
            {
              type: "VariableDeclarator",
              id: { type: "Identifier", name: { in: unusedNames } },
              init: { type: "CallExpression", callee: "require" },
            },
            () => {
