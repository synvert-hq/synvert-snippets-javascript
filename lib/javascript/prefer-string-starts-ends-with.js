...
new Synvert.Rewriter("javascript", "prefer-string-starts-ends-with", () => {
  ...
  withinFiles(Synvert.ALL_JS_FILES, () => {
    findNode(`.CallExpression[expression=.PropertyAccessExpression[expression=.RegularExpressionLiteral[text^='/^']][name=test]][arguments.0=.Identifier][arguments.length=1]`, () => {
