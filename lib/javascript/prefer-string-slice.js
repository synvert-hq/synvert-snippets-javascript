...
new Synvert.Rewriter("javascript", "prefer-string-slice", () => {
  ...
  withinFiles(Synvert.ALL_JS_FILES, () => {
    findNode(
      `.CallExpression[expression=.PropertyAccessExpression[expression=.Identifier][name=substr]][arguments.0=.Identifier][arguments.1=.Identifier][arguments.length=2]`,
      () => {
    ...
    findNode(
      `.CallExpression[expression=.PropertyAccessExpression[expression=.Identifier][name=substring]][arguments.0=.Identifier][arguments.1=.Identifier][arguments.length=2]`,
      () => {
        replace("expression.name", { with: "slice" });
      }
    );
