...
new Synvert.Rewriter("jquery", "deprecate-jqxhr-success-error-and-complete", () => {
  ...
  withinFiles(Synvert.ALL_FILES, function () {
    ...
    withNode({ type: "CallExpression", callee: { type: "MemberExpression", property: { in: Object.keys(functionMap) } }, arguments: { length: 1 } }, function () {
      ifExistNode({ type: "MemberExpression", object: { in: ['$', 'jQuery'] }, property: 'ajax' }, { in: 'callee' }, () => {
