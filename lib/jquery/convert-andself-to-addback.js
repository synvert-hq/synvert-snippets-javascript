...
new Synvert.Rewriter("jquery", "convert-andself-to-addback", () => {
  description(`
  ...
  withinFiles(Synvert.ALL_FILES, function () {
    withNode({ type: "CallExpression", callee: { type: "MemberExpression", object: /^\$/, property: 'andSelf' }, arguments: { length: 0 } }, () => {
