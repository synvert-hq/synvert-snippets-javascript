...
new Synvert.Rewriter("jquery", "prop-boolean-properties", () => {
  ...
  withinFiles(Synvert.ALL_FILES, function () {
    withNode(
      {
        type: "CallExpression",
        callee: { type: "MemberExpression", object: /^\$/, property: "attr" },
        arguments: { length: 2, first: { value: { in: booleanProperties } } },
      },
      () => {
    ...
    withNode(
      {
        type: "CallExpression",
        callee: { type: "MemberExpression", object: /^\$/, property: "removeAttr" },
