...
new Synvert.Rewriter("jquery", "use-expr-pseudos", () => {
  ...
  withinFiles(Synvert.ALL_JS_FILES, function () {
    ...
    // $.expr.pseudos
    findNode(
      ".MemberExpression[object=.MemberExpression[object IN ($ jQuery)][property=expr]][property.value=':']",
      () => {
    ...
    // $.expr.pseudos
    findNode(
      ".MemberExpression[object=.MemberExpression[object IN ($ jQuery)][property=expr]][property=filters]",
      () => {
