...
new Synvert.Rewriter("jquery", "use-expr-pseudos", () => {
  ...
  withinFiles(Synvert.ALL_FILES, function () {
    ...
    // =>
    // $.expr.pseudos
    withNode({ type: "MemberExpression", object: { type: "MemberExpression", object: { in: ['$', 'jQuery'] }, property: 'expr' }, property: { value: ':' } }, () => {
    ...
    // =>
    // $.expr.pseudos
    withNode({ type: "MemberExpression", object: { type: "MemberExpression", object: { in: ['$', 'jQuery'] }, property: 'expr' }, property: 'filters' }, () => {
