...
new Synvert.Rewriter("jquery", "deprecate-event-shorthand", () => {
  ...
  withinFiles(Synvert.ALL_FILES, function () {
    withNode({ type: "CallExpression", callee: { type: "MemberExpression", object: /^\$/, property: { in: eventShorthandNames } }, arguments: { length: 1, first: { type: { in: ["FunctionExpression", "ArrowFunctionExpression"] } } } }, () => {
      replace('callee.property', { with: 'on' });
      insert("'{{callee.property}}', ", { to: 'arguments.0', at: 'beginning' });
    });

    withNode({ type: "CallExpression", callee: { type: "MemberExpression", object: /^\$/, property: { in: eventShorthandNames } }, arguments: { length: 0 } }, () => {
