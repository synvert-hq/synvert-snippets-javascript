...
new Synvert.Rewriter("react", "import-named-component", () => {
  ...
  withinFiles(Synvert.ALL_FILES, function () {
    ifExistNode(
      { type: "ClassDeclaration", superClass: { type: "MemberExpression", object: "React", property: "Component" } },
      () => {
        // import React from 'react'
        // =>
        // import React, { Component } from 'react'
        ...
        withNode(
          {
            ...
            superClass: { type: "MemberExpression", object: "React", property: "Component" },
          },
          () => {
