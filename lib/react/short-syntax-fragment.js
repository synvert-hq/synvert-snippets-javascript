...
new Synvert.Rewriter("react", "short-syntax-fragment", () => {
  ...
  withinFiles(Synvert.ALL_FILES, function () {
    ...
    // =>
    // import React, { Component } from 'react'
    findNode(`.ImportDeclaration[moduleSpecifier.text="react"][importClause=.ImportClause[namedBindings=.NamedImports[elements.length>1]]] .ImportSpecifier[name=Fragment]`, () => {
      remove();
    });
    ...
    findNode(`.ImportDeclaration[moduleSpecifier.text="react"][importClause=.ImportClause[namedBindings=.NamedImports[elements.length=1][elements.0.name=Fragment]]]`, () => {
