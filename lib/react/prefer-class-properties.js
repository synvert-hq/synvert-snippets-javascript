...
new Synvert.Rewriter("react", "prefer-class-properties", () => {
  ...
  const ignoreMethods = ['componentDidMount', 'componentDidUpdate', 'componentWillReceiveProps', 'componentWillUnmount', 'componentDidCatch', 'constructor', 'render', 'shouldComponentUpdate'];
